				...
				<div id="carouselExampleIndicators" class="carousel slide"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="${contextPath}/resources/image/배너3.png" class="d-block w-100" alt="...">
						</div>
						<div class="carousel-item">
							<img src="${contextPath}/resources/image/배너1.png" class="d-block w-100" alt="...">
						</div>
						<div class="carousel-item">
							<img src="${contextPath}/resources/image/배너2.png" class="d-block w-100" alt="...">
						</div>
					</div>
			...
			<div class="main_cnt1 col-6">
				<div class="main_tabs">
					<ul class="nav nav-tabs">
						...
						<li class="nav-item2"><a class="nav-link active">자료실</a>
						</li>
