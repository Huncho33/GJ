...
<script language="javascript">
	...
	function fn_modFormData(attribute) {
		var value;
		var infoAdm_frm = document.infoAdm_frm;
		if(attribute == 'member'){
...
<body>
	<div id="infoAdm_wrapper">
		<div id="infoAdm_total">
			<div id="khs_sideMenu_tot">
				...
				<div id="khs_subMenu">
					<ul>
						...
						<li><a id="khs_left khs_left2" class="khs_lnb"><p>신청 관리</p></a>
							<ul class="khs_depth2">
			...
			<div id="infoAdm_tot">
				<div id="infoAdm_tit1">
					<h3 class="infoAdm_tit">사용자 관리</h3>
				</div>
				<form id="infoAdm_frm" name="infoAdm_frm">
					<div id="infoAdm_tit2">
						<p class="infoAdm_subtit" style="font-weight: bold;">
							<strong>｜</strong> 로그인 정보
						</p>
					</div>
					<div id="infoAdm_container">
						<div class="infoAdm_cnt1">
							<table>
								<tr height="50">
									<td width="150">:: 아이디</td>
					...
					<div id="infoAdm_container">
						...
						<div class="infoAdm_cnt2">
							<div class="join_btn join_btn2">
								<input type="submit" value="수정" id="infoAdm_mod"
									name="infoAdm_mod"
