...
<link href="${contextPath }/resources/css/admin/free/viewArticle.css" rel="stylesheet" type="text/css">
...
function backToList(obj){
    obj.action="${contextPath}/adminFree/listArticles.do";
    obj.submit();
  }
 ...
 function fn_modify_article(obj){
    obj.action="${contextPath}/adminFree/modArticle.do";
    obj.submit();
 }
   ...
   function fn_removeModImage(_up_fileNO, _fr_NO, _up_fileName, rowNum){
       alert(rowNum);
          $.ajax({
             type:"post",
             async:false,  
             url:"http://localhost:8090/GJ/adminFree/removeModImage.do",
             dataType:"text",
             ...
             success:function (result, textStatus){
                if(result == 'success'){
                   ...
                   location.href="http://localhost:8090/GJ/adminFree/viewArticle.do?removeCompleted=true&fr_NO=" + _fr_NO;
					...
					<table id="fr_select_view">
						...
						<tr id="table_mainCnt">
							...
							<td class="table_container" colspan=3><textarea rows="20"
									cols="110" name="fr_context" id="fr_context" disabled>${article.fr_context }</textarea></td>
						</tr>
						<!--  파일 업로드 -->
						<c:set var="img_index" />
						<c:choose>
							...
							<div id="freeView_mainBtn">
								<div id="freeView_mainBtn" class="freeView_btn freeView_btn3">
										<input type=button value="삭제하기"
											onClick="fn_remove_article('${contextPath}/adminFree/removeArticle.do', ${article.fr_NO})">
								</div>
