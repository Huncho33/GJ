...
<link href="${contextPath}/resources/css/admin/qna/viewQna.css" rel="stylesheet" type="text/css">
							...
							<tbody>
								...
								<tr id="table_mainCnt">
									...
									<td class="table_container" colspan=2><textarea id="qna_content"
											name="qna_content" rows="20" cols="110" maxlength="4000"
							...
							<div class="qnaView_btn_list qnaView_btn_list2">
								...
								<div class="qnaView_btn qnaView_btn2">
									<input type="button" value="답글쓰기"
										onClick="fn_reply_qna('${contextPath}/adminQna/replyForm.do', ${qna.qna_no})">
								</div>
							</div>
						</c:if>
