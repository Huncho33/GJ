...
<script type="text/javascript">
	...
	function backToList(obj) {
		if (confirm("답글 작성을 취소하고 목록으로 돌아가시겠습니까?") == true) {
			window.location.href = "${contextPath}/adminQna/listQnas.do";
		} else {
			return false;
		}
	}
	...
	<div id="replyFrm_bground">
		<div id="replyFrm_cnt">
			...
			<div id="replyFrm_table">
				...
				<form name="QnaForm" method="post" accept-charset="utf-8" action="${contextPath}/adminQna/addNewReply.do">
							...
							<tbody>
								...
								<tr class="dot_line">
									...
									<td colspan=2><input type="password" size="20"
										...
										type="hidden" size="20" maxlzength="4" id="qna_pw2"
										name="qna_pw2"></td>
								</tr>
								<tr class="dot_line">
