...
<body>
		...
		<div id="container">
			<div class="logo1">
				<a href="https://www.daegu.go.kr/index.do"><img
					src="img/대구광역시로고.png" height="40px">
			</div>

			<div class="sns">
				<ul class="sns_link">
					<li><a href="#"> <img src="img/kakaotalk.png"
							height="25px">
					</a></li>
					<li><a href="#"> <img src="img/facebook.png" height="25px">
					</a></li>
					<li><a href="#"> <img src="img/insta.png" height="25px">
					</a></li>
				</ul>
	...
	<div id="header_mid">
		<div id="header_mid1">
			<div id="inner">
				<div class="logo2">
					<h1>
						<a href="#"><img src="img/원스톱청년주거 로고.png">
					</h1>
				</div>
			</div>
		</div>
	...
	<div id="header_bottom">
		...
		<div class="info">
			<a href="${contextPath}/member/loginForm.do"><img src="img/user.png"><p>로그인</p></a>
				 
			<a href="#"><img src="img/file.png"><p>회원가입</p> </a>
		</div>
	</div>
