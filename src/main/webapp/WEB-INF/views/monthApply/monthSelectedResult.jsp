		...
		<div id="monthApply_total">
			<div name="frmResult">
				<div id="result_tit">
					<p>
						...
						결과는<span><input id="result_title" type="text"
							name="member_id" value="${apply.mo_result}" disabled></span>입니다.
					</p>
				</div>
						...
						<tbody>
							<tr class="dot_line">
								...
								<td><input type="text" name="member_id"
									id="Apply_PolicyName" value="${apply.mo_date}"
							...
							<tr class="dot_line">
								...
								<td><input type="text" name="Apply_PolicyName"
									id="Apply_PolicyName" value="${apply.mo_result}"
									style="border: 0; background: #fff;" disabled></td>
							</tr>
				...
				<div id="monthApply_table">
					<div class="join_btn1">
						<button
							onclick="location.href='${contextPath}/mypage/monthApplyList.do'">나의신청현황확인</button>
					</div>
				</div>
			</div>
