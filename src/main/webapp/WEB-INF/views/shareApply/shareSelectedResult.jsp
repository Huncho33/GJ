	...
	<div id="monthApply_bground">
		<div id="monthApply_total">
				...
				<div id="result_tit">
					<p>
						<input id="member_name" type="text" name="member_name"
							value="${member.member_name}" disabled>님의 청년희망주택이자지원 신청
						결과는<span>
						<input id="result_title" type="text" name="member_id" value="${apply.sh_result}" disabled></span>입니다.
					</p>
				</div>
					...
					<tbody>
						<tr class="dot_line">
							...
							<td><input type="text" name="member_id"
								id="Apply_PolicyName" value="${apply.sh_date}"
						...
						<tr class="dot_line">
							...
							<td><input type="text" name="Apply_PolicyName"
								id="Apply_PolicyName" value="${apply.sh_result}"
								style="border: 0; background: #fff;" disabled></td>
						</tr>
			...
			<div id="monthApply_table">
					...
					<div class="join_btn1">
						<button onclick ="location.href='${contextPath}/mypage/shareApplyList.do'">나의신청현황확인</button>
					</div>
				</div>
			</div>
