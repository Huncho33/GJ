...
//우편번호 검색 기능
	...
	function fn_modify_apply(form){
		form.action="${contextPath}/mypage/updateAlarmApply.do";
		form.submit();
    }
							...
							<table id="myApplyView_viewTable" align="center" width="100%"
								...
								<tbody>
									...
									<tr align="center">
										...
										<td colspan="3" width="75%"><input type="text"
											id="member_roadAddress" name="member_roadAddress"
											id="member_roadAddress" value="${member.member_roadAddress}"
											>
									...
									<tr align="center">
										<td colspan="3" width="75%"><input type="hidden"
											...
											type="hidden" id="member_jibunAddress"
											name="member_jibunAddress"
											value="${member.member_jibunAddress}"> <input
											type="text" id="member_namujiAddress"
											name="member_namujiAddress"
