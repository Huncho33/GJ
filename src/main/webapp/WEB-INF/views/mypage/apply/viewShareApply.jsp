					...
					<form name="applyFrm" id="applyFrm" method="post"
						...
						<div class="myInfo_cnt2">
							...
							<div id="applyView_btn">
								<c:choose>
									<c:when test="${share.sh_result == '심사대기'}">
										<div class="join_btn join_btn3">
											<input type="button" value="신청취소"
												onClick="fn_remove_apply('${contextPath}/mypage/removeShareApply.do', ${share.sh_no})">
										</div>
										<div class="join_btn join_btn1">
								...
								<c:choose>
									<c:when test="${share.sh_result == '승인'}">
										<div class="join_btn join_btn2">
											<input type="button" value="변경신청" id="myInfo_mod"
												name="myInfo_mod" onClick="location.href='${contextPath}/mypage/modShareApplyView.do'">
										</div>
									</c:when>
								</c:choose>
							</div>
