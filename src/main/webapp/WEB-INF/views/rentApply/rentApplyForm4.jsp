		...
		<div id="monthApply_total">
			...
			<div id="monthApply_fileTot">
					...
					<table id="join_detail_table">
						<tr class="dot_line">
							...
							<td><input type="text" name="Apply_PolicyName"
								id="Apply_PolicyName" value="전월세보증금이자지원"
				...
				<div id="monthApply_title3">
					<form method="post"
						action="${contextPath}/rent/rentApplyForm4.do"
						...
						<div id="d_file">
							<input type="hidden" name="rent_reason" value="null" /> <input
								type="hidden" name="rent_policy" value="null" /> <input
								type="hidden" name="rent_date" value="null" />
						</div>
					</form>
				</div>
			</div>
