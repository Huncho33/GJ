		...
		<div id="monthApply_total">
			...
			<div id="monthApply_fileTot">
					...
					<table id="join_detail_table">
						<tr class="dot_line">
							...
							<td><input type="text" name="Apply_PolicyName"
								id="Apply_PolicyName" value="귀환신혼부부전세지원"
				...
				<div id="monthApply_title3">
					<form method="post"
						action="${contextPath}/back/backApplyForm4.do"
						...
						<div id="d_file">
							<input type="hidden" name="ba_reason" value="null" /> <input
								type="hidden" name="ba_policy" value="null" /> <input
								type="hidden" name="ba_date" value="null" />
						</div>
					</form>
				</div>
			</div>
