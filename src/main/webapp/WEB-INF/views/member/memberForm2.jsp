					...
					<div class="joinForm2_innerCnt">
						<div class="joinForm2_cnt1">
							<ul>
								...
								<p>- 대구시는 사용자의 개인정보보호를 위해 사용자 여러분이 대구시 누리집의 서비스를 이용함에 있어
									온라인상에서 대구시에서 제공한 개인정보가 보호 받을 수 있도록 최선을 다하고 있습니다.</p>
							</ul>
						</div>
						<div class="joinForm2_cnt2">
							<div class="joinForm2_certiList">
								<div class="joinForm2_certiTit">
									<p>
										<span>'이메일, 휴대폰' </span>사용자 인증 중, 선택하여 본인 인증을 완료해주세요.
									</p>
								</div>
								<div class="joinForm2_certimenu">
									<div class="joinForm2_cerTitle joinForm2_cerTitle1">
										<p>이메일 인증</p>
										<a class="joinForm2_cerBtn"
											href="${contextPath}/member/emailSend.do">인증하기</a>
									</div>
									<div class="joinForm2_cerTitle joinForm2_cerTitle2">
										<p>휴대폰 인증</p>
