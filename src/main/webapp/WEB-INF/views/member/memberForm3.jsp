...
=======
    <meta charset="utf-8">
    <script src="http://dmaps.daum.net/map_js_init/postcode.v2.js"></script>
    <link href="${contextPath}/resources/css/memberForm/memberForm3.css" rel="stylesheet" type="text/css">
    <script src="${contextPath}/resources/js/memberForm/memberForm3.js"></script>
    <script language="javascript">
        // 우편번호 검색 기능
        function execDaumPostcode() {
        ...
        function formCheck(form) {
            ...
            if (!checkPhone.test(member_phoneno.value)) {
               alert("특수문자 없이 11자리 숫자로 입력하세요.(예)01011111234");
               return false;
            }
            if (form.member_email1.value == "" || form.member_email2.value == "") {
                alert('이메일을 입력하세요.')
...
<body>
    <div id="Memjoin_bground">
        <div id="Memjoin_total">
            ...
            <div id="Memjoin_title">
                <p class="Memjoin_tit" style="font-weight: bold;"><i class="fa-solid fa-pen"></i>&nbsp;정보입력(<span style="font-weight: bold ; color: red;">*</span>는 필수입력사항입니다.)</p>
            </div>
            <div id="Memjoin_table">
                <form action="${contextPath}/member/addMember.do" method="post" onsubmit="return formCheck(this)">
                    <div id="detail_table">
                        <table id="join_detail_table">
                            <tbody>
                                <tr class="dot_line">
                                    <td class="fixed_join">:: 아이디<span style="font-weight: bold ; color: red;">*</span>
                                    </td>
                                    <td colspan="2">
                                ...
                                <tr class="dot_line">
                                    <td></td>
                                    <td colspan="2"><a class="join_rule">&nbsp; * 영문과 숫자로 이루어진 4~12자의 아이디를 입력하세요</a>
                                    </td>
                                </tr>
                                <tr class="dot_line">
                                    <td class="fixed_join">:: 비밀번호<span style="font-weight: bold ; color: red;">*</span>
                                    </td>
                                    <td colspan="2"><input id="member_pw" name="member_pw" type="password" size="20" />
                                </tr>
                                <tr class="dot_line">
                                    <td></td>
                                    <td colspan="2"><a class="join_rule">&nbsp; * 영문 대소문자, 숫자, 특수기호로 이루어진 8~25 자의 비밀번호를
                                            입력하세요.</a>
                                    </td>
                                </tr>
                                <tr class="dot_line">
                                    <td class="fixed_join">:: 비밀번호 확인<span style="font-weight: bold ; color: red;">*</span>
                                    </td>
                                    <td><input id="member_pwck" name="member_pwck" type="password" size="20" />
                                    <td>
	                                	<div id="pwck1" style="color: lime; display: none; font-size: 12px;">&nbsp;&nbsp;비밀번호가 일치합니다.</div>
	                                	<div id="pwck2" style="color: red; display: none; font-size: 12px;">&nbsp;&nbsp;비밀번호가 일치하지 않습니다.</div>
                                	</td>
                                </tr>
                                <tr></tr>
                                
                                <tr class="dot_line">
                                    <td class="fixed_join">:: 이름<span style="font-weight: bold ; color: red;">*</span>
                                    </td>
                                    <td colspan="2"><input name="member_name" type="text" size="20" /></td>
                                </tr>
                                <tr class="dot_line">
                                    <td class="fixed_join">:: 성별<span style="font-weight: bold ; color: red;">*</span>
                                    </td>
                                    <td colspan="2"><input type="radio" name="member_gender" value="F" /> 여성<span
                                            style="padding-left: 120px"></span> <input type="radio" name="member_gender"
                                            value="M" checked />남성</td>
                                </tr>
                                <tr class="dot_line">
                                    <td class="fixed_join">:: 생년월일<span style="font-weight: bold ; color: red;">*</span>
                                    </td>
                                    <td colspan="2"><input type="text" name="member_birth" id="member_birth"
                                            size="20" />
                                    </td>
                                </tr>
                                <tr class="dot_line">
                                    <td></td>
                                    <td colspan="2"><a class="join_rule">&nbsp; * 8자리 생년월일을 숫자만 입력하세요. EX)yyyyMMdd</a>
                                    </td>
                                </tr>
                                <tr class="dot_line">
                                    <td class="fixed_join">:: 휴대전화번호<span
                                            style="font-weight: bold ; color: red;">*</span></td>
                                    <td colspan="2"><input type="text" name="member_phoneno" id="member_phoneno"
                                            size="20" />
                                    </td>
                                </tr>
                                <tr class="dot_line">
                                    <td></td>
                                    <td colspan="2"><a class="join_rule">&nbsp; * 특수문자 없이 숫자만 입력하세요. EX)01011111234
                                        </a></td>
                                </tr>
                                ...
                                <tr class="dot_line">
                                    ...
                                    <td colspan="2"><input size="10px" type="text" id="member_email1"
                                            name="member_email1" /> @
                                        <input size="10px" type="text" id="member_email2" name="member_email2" />
                                        <select id="_member_email2" name="_member_email2" onChange=emailSelect()
                                            title="직접입력">
                                            <option value="non">직접입력</option>
                                            <option value="hanmail.net">hanmail.net</option>
                                            <option value="daum.net">daum.net</option>
                                ...
                                <tr class="dot_line">
                                    ...
                                    <td><input type="text" id="member_zipcode" name="member_zipcode" size="10">
                                        <button><a href="javascript:execDaumPostcode()"
                                                class="postcode">우편번호검색</a></button>
                                    </td>
                                </tr>
                                <tr class="dot_line">
                                    <td class="fixed_join"></td>
                                    ...
                                    <td><input type="text" id="member_roadAddress" name="member_roadAddress" size="50">
                                    </td>
                                </tr>
                                <tr class="dot_line">
                                    <td class="fixed_join"></td>
                                    <td class="fixed_join fixed_join1">지번 주소</td>
                                    <td><input type="text" id="member_jibunAddress" name="member_jibunAddress"
                                            size="50"></td>
                                </tr>
                                <tr class="dot_line">
                                    <td class="fixed_join"></td>
                                    <td class="fixed_join fixed_join1">상세 주소</td>
                                    <td><input type="text" id="member_namujiAddress" name="member_namujiAddress"
                                            size="50"></td>
                                </tr>
                            </tbody>
                        </table>
