...
@Controller
public class FileRetApplyDownloadController {
	private static String retApply_REPO = "C:\\GJ\\file_repo\\apply\\rentReturn";;
	@RequestMapping("/retApplyDownload.do")
	protected void download(@RequestParam("up_filename") String up_filename, @RequestParam("ret_no") String ret_no,
		...
		try {
            ...
            String filePath = retApply_REPO + "\\" + ret_no + "\\" + up_filename;
