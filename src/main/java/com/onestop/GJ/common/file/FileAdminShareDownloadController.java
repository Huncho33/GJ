...
@Controller
public class FileAdminShareDownloadController {
	private static String admin_shareApply_REPO = "C:\\GJ\\file_repo\\admin\\apply\\share";
	@RequestMapping("/adminShareDownload.do")
	protected void download(@RequestParam("up_filename") String up_filename, @RequestParam("sh_no") String sh_no,
		...
		try {
            ...
            String filePath = admin_shareApply_REPO + "\\" + sh_no + "\\" + up_filename;
