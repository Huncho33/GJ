...
@Controller
public class FileAdminRentDownloadController {
	private static String admin_rentApply_REPO = "C:\\GJ\\file_repo\\admin\\apply\\rent";
	@RequestMapping("/adminRentDownload.do")
	protected void download(@RequestParam("up_filename") String up_filename, @RequestParam("rent_no") String rent_no,
		...
		try {
            ...
            String filePath = admin_rentApply_REPO + "\\" + rent_no + "\\" + up_filename;
