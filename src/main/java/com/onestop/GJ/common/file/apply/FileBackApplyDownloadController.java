...
@Controller
public class FileBackApplyDownloadController {
	private static String backApply_REPO = "C:\\GJ\\file_repo\\apply\\back";;
	@RequestMapping("/backApplyDownload.do")
	protected void download(@RequestParam("up_filename") String up_filename, @RequestParam("ba_no") String ba_no,
		...
		try {
            ...
            String filePath = backApply_REPO + "\\" + ba_no + "\\" + up_filename;
